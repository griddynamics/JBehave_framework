...
<form class="pure-form pure-form-aligned" method="post" modelAttribute="testArea" action="testAreaCreated">
    ...
    <fieldset>
        ...
        <div class="pure-control-group">
            <label for="wiposYdth">posY</label>
        ...
        <div class="pure-control-group">
            ...
            <input name="browserWidth" value="${testArea.browserWidth}"/>
        </div>
        <div class="pure-control-group">
            <label for="browserHeight">browser height</label>
            <input name="browserHeight" value="${testArea.browserHeight}"/>
        </div>
        <div class="pure-control-group">
            <label for="browserName">browser name</label>
            <input name="browserName" value="${testArea.browserName}"/>
        </div>
        <div class="pure-control-group">
