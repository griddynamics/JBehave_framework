...
<table id="testSessions" class="pure-table">
  <thead><tr>
        <td>Test Sessions timestamps</td>
    </tr>
  </thead>

  <c:forEach items="${testResultList}" var="testResult">
    <tr>
      <td><a href="/testCases?sessionId=${testResult.testSessionTs}">${testResult.testSessionTs}</a></td>
    </tr>
  </c:forEach>
